...
import 'package:flutter_app/route/project_selector_popup.dart';
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          color: isMenuOpen ? Colors.transparent : Colors.transparent,
          padding: EdgeInsets.symmetric(horizontal: 30.0),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[
              Text(widget.classifyData.name?.replaceAll("&amp;", "&"), style: TextStyle(fontSize: 20.0,color: Colors.black)),
              Icon(isMenuOpen ? Icons.arrow_drop_up : Icons.arrow_drop_down,color: Colors.black,)
            ],
          ),
        ),
      ),
